...
#define HARDWARE_LEVEL 2 
  1 für originales Layout mit Schalter auf Pin 19/22/21
  2 für neues Layout für "New Heltec Wifi Kit 32" (V2) mit Schalter auf Pin 23/19/22

#define ROTARY_SCALE 2   
  Die Rotary Encoder liefern unterschiedliche Increments pro Stufe. Das kann hier angepasst werden.
...
#define USE_POTI         // Poti benutzen -> ACHTUNG, im Normalfall auch USE_ROTARY_SW deaktivieren!
  aktivieren, wenn ein Poti für die Steuerung des Interface genutzt wird.
...
Setup:
------
Hier können verschiedene Grundeinstellungen vorgenommen werden:
...
Achtung: Da auch teilgefüllte Gläser befüllt werden, kann ein abweichendes Gewicht des leeren Glases nicht
         ...
         Ein halb volles 125g Glas kann die Befüllung mit 500g auslösen...
