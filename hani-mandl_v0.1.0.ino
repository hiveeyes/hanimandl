...
void Serial_print_value(String displayname, int value) {
  Serial.print(displayname);
  Serial.println(value);
}

void Serial_print_value(String displayname, float value) {
  Serial.print(displayname);
  Serial.println(value);
}
...
void GetPreferences(void) {
  ...
  Serial_print_value("faktor = ", faktor);
  Serial_print_value("tara_raw = ", tara_raw);
  Serial_print_value("tara = ", tara);
  preferences.end();
}

void setup_tara(void) {
  u8g2.setCursor(0, 8);
  u8g2.print("*");
...
void loop()
{
  ...
  // Handbetrieb //
  if ((digitalRead(betrieb_button) == LOW)
      && (digitalRead(setup_button) == LOW))
    process_handbetrieb();
}
